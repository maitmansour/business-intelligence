...
import logging
logging.basicConfig(filename='../../logs/classifiers-all-numeric.log',level=logging.DEBUG,format='%(asctime)s %(message)s')
...
print('\n Accuracy Score for Categorical and Numeric data : \n')
accuracy_score(lst_classif,lst_classif_names,full_data,Y)