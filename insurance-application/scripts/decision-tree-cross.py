...
import logging
logging.basicConfig(filename='../logs/decision-tree-cross.log',level=logging.DEBUG,format='%(asctime)s %(message)s')
...
#tree.export_graphviz(tree_model,out_file="../plot/decision-tree-cross.gv") 
#render('dot', 'png', "../plot/decision-tree-cross.gv")  
#
## Predict Test data
